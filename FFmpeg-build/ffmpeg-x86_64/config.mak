...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cc=/usr/bin/gcc --as='gas-preprocessor.pl /usr/bin/gcc' --nm= --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.8.sdk --enable-cross-compile --enable-pic --target-os=darwin --arch=x86_64 --cpu=x86_64 --extra-ldflags='-arch x86_64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.8.sdk' --extra-cflags='-arch x86_64' --prefix=/Users/dglancy/dev/hetissimpel/radio/FFmpeg-build/dist-x86_64 --disable-swscale --disable-avfilter --disable-decoders --enable-decoder=wmapro --enable-decoder=wmav1 --enable-decoder=wmav2 --disable-encoders --disable-hwaccels --disable-muxers --disable-demuxers --enable-demuxer=asf --enable-demuxer=rtp --enable-demuxer=rtsp --enable-demuxer=xwma --disable-parsers --disable-protocols --enable-protocol=http --enable-protocol=tcp --enable-protocol=mmsh --enable-protocol=mmst --enable-protocol=rtp --disable-bsfs --disable-indevs --disable-outdevs --disable-filters --disable-avdevice --disable-debug --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --extra-ldflags=-L/Users/dglancy/dev/hetissimpel/radio/FFmpeg-build/dist-x86_64/lib --extra-cflags=-I/Users/dglancy/dev/hetissimpel/radio/FFmpeg-build/dist-x86_64/include --disable-asm
prefix=/Users/dglancy/dev/hetissimpel/radio/FFmpeg-build/dist-x86_64
...
CC_IDENT=Apple LLVM version 5.0 (clang-500.2.78) (based on LLVM 3.3svn)
ARCH=c
CC=/usr/bin/gcc
CXX=g++
...
DEPCC=/usr/bin/gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=gas-preprocessor.pl /usr/bin/gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=ar
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.8.sdk -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS=  -arch x86_64 -I/Users/dglancy/dev/hetissimpel/radio/FFmpeg-build/dist-x86_64/include  -std=c99 -fomit-frame-pointer -fPIC -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -arch x86_64 -I/Users/dglancy/dev/hetissimpel/radio/FFmpeg-build/dist-x86_64/include  -fPIC
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -arch x86_64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.8.sdk -L/Users/dglancy/dev/hetissimpel/radio/FFmpeg-build/dist-x86_64/lib  --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.8.sdk -Wl,-dynamic,-search_paths_first
